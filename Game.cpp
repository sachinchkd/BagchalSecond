	...
	int height, int flags)
{
	...
	if (!TextureManager::Instance()->load("assets/pointMain.png", "point", m_pRenderer))
	{
		return false;
	}
	if (!TextureManager::Instance()->load("assets/board.png", "board", m_pRenderer))
	{
		return false;
	}
	if (!TextureManager::Instance()->load("assets/tigerMain.png", "sachin", m_pRenderer))
	{
		return false;
	}
...
void Game::render()
{
	...
	TextureManager::Instance()->draw("board", 200, 200, 600, 600, m_pRenderer);
	...
	TextureManager::Instance()->draw("sachin", 150, 150, 100, 100, m_pRenderer);
	TextureManager::Instance()->draw("sachin", 150, 750, 100, 100, m_pRenderer);
	TextureManager::Instance()->draw("sachin", 750, 150, 100, 100, m_pRenderer);
	TextureManager::Instance()->draw("sachin", 750, 750, 100, 100, m_pRenderer);
